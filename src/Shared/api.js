...
// };
  ...
  export const combinationPostApi = {
        // 꿀조합 게시글 작성하기
        postCombinationPost : list => instance.post("/api/v1/post",list,
        { headers : { 
            "content-type": "application/json;charset=UTF-8", 
            accept: "application/json", 
            authorization: `Bearer ${localStorage.getItem("token")}` }, }
        ...
        // 꿀조합 게시글 수정하기
        patchCombinationPost : list => instance.patch(`/api/v1/post/postupdate/${postid}`, list),

        // 꿀조합 게시글 삭제하기
        deleteCombinationPost : list => instance.delete(`/api/v1/post/postdelete/${postid}`, list,
        { headers : { 
          "content-type": "application/json;charset=UTF-8", 
          accept: "application/json", 
          authorization: `Bearer ${localStorage.getItem("token")}` }, }
        ...
        // 꿀조합 게시글 불러오기
        getCombinationList : list => instance.post("/api/v1/post", list),
  }
